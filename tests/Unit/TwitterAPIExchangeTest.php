...
class TwitterAPIExchangeTest extends TestCase
{
     ...
     * @var string
     */
    const CONSUMER_KEY = 'NnlnoxxHSv7bXwP8Un1vsv38Z';

    /**
     * @var string
     */
    const CONSUMER_SECRET = 'GcR6re0pdXX5yWZW5QXx4ltEhRaRPOkXPbo3uDSh1j6mmB3vYV';

    /**
     * @var string
     */
    const OAUTH_ACCESS_TOKEN = '1252350081979699200-sYamfflVZJF7Fnp2fsk6Zyml0qcAsT';

    /**
     * @var string
     */
    const OAUTH_ACCESS_TOKEN_SECRET = 'sdvi2WfyIjTnSTMlpGSzVvSyo8cS5EvF1SrTUjTKfzjyv';
    ...
    {
        $url    = 'https://ads-api.twitter.com/1.1/accounts/hkk5/campaigns/8zwv';
        $method = 'PUT';
        $params = array (
            'name'   => 'Important',
            'paused' => true
    ...
    public function testDelete()
    {
        ...
        $url = 'https://ads-api-sandbox.twitter.com/1.1/accounts/foobaa';
        $method = 'DELETE';
...
//@@@ Maziar
     ...
     *
     */
    public function testCanSearchTweets()
    {
        $url    = 'https://api.twitter.com/1.1/search/tweets.json';
        $method = 'GET';
        $params = '?q=%40KidspotSocial';

        $data     = $this->exchange->request($url, $method, $params);
        $expected = 'It\'s important to be physically';
